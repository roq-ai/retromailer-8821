...
function ClientListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ClientInterface[]>(
    ...
    () =>
      getClients({
        relations: ['user', 'email_list.count', 'template.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('email_list', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>email_list</Th>}
